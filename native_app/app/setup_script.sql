...
-- In-app diagnostics only (no egress). Consumers can copy a code for support threads.
CREATE TABLE IF NOT EXISTS APP_SCHEMA.DIAGNOSTICS (
...
GRANT SELECT, INSERT ON TABLE APP_SCHEMA.DIAGNOSTICS TO APPLICATION ROLE APP_USER;
